...
function renderHandleiding(){
  ...
  secties.verkoper = sectie('verkoper', '👤 Verkoper', ''
    ...
    + stap(7,'Voortgang en samenvatting','Het voortgangspercentage bovenin toont hoeveel verplichte velden per fase zijn ingevuld. Via het samenvattingsscherm ziet u in één overzicht wat nog ontbreekt.')
  ...
  secties.begeleider = sectie('begeleider', '🧭 Begeleider (binnen een traject)', ''
    ...
    + stap(5,'Groepsstructuur beheren','Registreer entiteiten (holding + werkmaatschappijen) zodat documenten er correct aan gekoppeld worden en groepscijfers automatisch worden opgeteld.')
    + stap(6,'Gefaseerde koper-toegang','Via het koper-toegangsscherm bepaalt u per DD-categorie of en wanneer de koper die mag inzien.')
    + stap(7,'Informatieverzoeken en Q&amp;A','Stuur gerichte informatieverzoeken naar de verkoper per fase, en beheer het Q&amp;A-verkeer tussen koper en verkoper.')
    + stap(8,'Wijzigingenlog','Elke wijziging, upload of verwijdering door de verkoper wordt gelogd met een meldingsbadge, zodat niets ongemerkt verandert.')
  );
