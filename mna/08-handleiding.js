...
function renderHandleiding(){
  ...
  secties.verkoper = sectie('verkoper', '👤 Verkoper', ''
    ...
    + stap(2,'De 7 informatiefases doorlopen','Het dossier is verdeeld in 7 fases: Financieel, Klanten &amp; commercieel, Partners &amp; personeel, Compliance &amp; kwaliteit, IT &amp; automatisering, Juridisch &amp; fiscaal, Strategisch &amp; markt. Fase 2-velden (aanvullende, diepere vragen) worden pas zichtbaar ná ondertekening van de LoI — dat is bewust zo, niet een fout in het scherm. Binnen fase 2 van "Financieel" staat een blok "— Balans &amp; schuld" (nettoresultaat, eigen vermogen, balanstotaal, liquide middelen, kortlopende/langlopende schulden, rentelasten, aflossingsverplichting) — deze velden zijn niet verplicht, maar voeden wel de financiële ratio\'s (solvabiliteit, ROE, ROA, current/quick ratio, DSCR, netto schuld/EBITDA) die daarna op het waarderingsscherm verschijnen. Een ratio verschijnt alleen als de bijbehorende velden zijn ingevuld — ontbrekende data geeft geen 0%, die ratio blijft dan gewoon weg.')
  ...
  secties.begeleider = sectie('begeleider', '🧭 Begeleider (binnen een traject)', ''
    ...
    + stap(2,'Dashboardoverzicht','U ziet de voortgang per fase, de dataroom, het Q&amp;A-register, en — indien de module "Contracten" actief is — knoppen om documenten te genereren: NDA, LoI, BEM (bemiddelingsovereenkomst), Excl (exclusiviteitsovereenkomst), Dealvoorstel, Bieding, SPA en Closing-checklist (een algemene controlelijst ter voorbereiding op closing — juridische documentatie, financiële afwikkeling, corporate handelingen en post-closing-aandachtspunten, geen juridisch advies). Is de module niet actief, dan zijn de knoppen zichtbaar maar vergrendeld. Bij "Dealvoorstel" kunt u naast het basisscenario ook optioneel een buy-and-build platformscenario en/of een vendor loan (verkoperslening) meenemen — bij die laatste berekent het platform een echt aflossingsschema (rente + aflossing per jaar, lineair of aflossingsvrij met een bullet-aflossing aan het einde van de looptijd), dat als aparte tabel in het dealvoorstel verschijnt. Ook kunt u alternatieve waarderingsmethodes laten meetonen: intrinsieke waarde (rechtstreeks uit het ingevulde eigen vermogen), liquidatiewaarde en de goodwill-methode. De liquidatie- en goodwill-percentages vult u zelf in — dit zijn bewust geen vooringevulde branchenormen, u kent uw eigen aannames of richtlijn het beste. Tot slot kunt u een synergie-analyse toevoegen: kosten- en omzetsynergieën (eigen inschatting, bijv. op basis van het cross-sell-percentage uit de DD) bouwen lineair op tot volledige realisatie en worden verdisconteerd tot een NPV — zo krijgt het cross-sell-DD-veld eindelijk een concrete waardebijdrage in plaats van alleen een kengetal te zijn. Ook is er een scenarioanalyse (downside/base/upside): breder dan de bestaande gevoeligheidstabel, omdat hier de EBITDA over de volledige horizon doorgroeit met een af- of opwaartse afwijking op de groeivoet — die bandbreedte stelt u zelf in. Tot slot kan bij de DCF-kruiscontrole een gevoeligheidsmatrix getoond worden: de DCF-uitkomst voor een reeks combinaties van discontovoet (WACC) en terminale groeivoet, de twee aannames waar een DCF het gevoeligst voor is — een "n.v.t."-cel betekent dat die combinatie wiskundig ongeldig is (WACC moet hoger zijn dan de groeivoet). Bij het versturen van een LoI of een indicatieve bieding is een extra veld "Intern goedgekeurd door" verplicht — pas als dat is ingevuld én het akkoord-vinkje is aangevinkt, wordt de verzendknop actief. Dit wordt vastgelegd in het logboek (wie, wanneer, welk document, welk verzendkanaal) — een bewuste, lichte controlestap vóór het versturen van deze twee dealkritieke documenten.')
    + stap(3,'AI-analyse &amp; waardering','Twee waarderingsfeatures naast elkaar: (1) de deterministieke rekenkern voor closing/earn-up/buy-and-build-scenario\'s, inclusief IRR en Multiple-on-Money bij buy-and-build; (2) een onafhankelijke AI-"second opinion" die zelf een multiple/bandbreedte bepaalt op basis van sectorbenchmarks, met bronvermelding en een automatische sanity-check. Op het waarderingsscherm staat naast de PDF-knop ook een CSV-knop — downloadt de financiële basis, kengetallen/ratio\'s, waardebepaling, rolling forecast en earn-out-structuur als één bestand dat direct in Excel opent. De waardebepaling en de earn-out-structuur staan er ook als grafiek bij: een staafdiagram voor de laag/midden/hoog-bandbreedte en een waterfall-grafiek die laat zien hoe de koopsom bij closing plus de jaarlijkse earn-out-uitkeringen optellen tot het totaal.')
    ...
    + stap(8,'Informatieverzoeken en Q&amp;A','Stuur gerichte informatieverzoeken naar de verkoper per fase, en beheer het Q&amp;A-verkeer tussen koper en verkoper. Bij elke vraag kunt u een deadline zetten ("beantwoorden vóór") — een onbeantwoorde vraag na die datum krijgt een rode waarschuwing — en de vraag toewijzen aan een naam (bijv. uzelf of een collega) als geheugensteun. Na een antwoord blijft de vraag open voor een reactiedraad: koper en u kunnen erover doorpraten i.p.v. dat het bij één antwoord stopt.')
