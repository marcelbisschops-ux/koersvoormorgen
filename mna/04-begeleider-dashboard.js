...
function toonVOKPopup(code, onAkkoord) {
  ...
  mo.innerHTML = '<div style="font-family:Playfair Display,serif;font-size:1.2rem;color:var(--head);font-weight:600;margin-bottom:.4rem">Verwerkersovereenkomst</div>'
    + '<div style="font-size:11px;color:var(--muted);margin-bottom:1rem">Versie 1.0 · ' + BRAND.bedrijf + ' · Vereist voor gebruik van ' + BRAND.platform + '</div>'
...
function renderLogin(){
  return '<div class="wrap narrow anim" style="padding-top:3rem">'
    ...
    +'<div style="margin-top:1rem;padding:.75rem 1rem;background:rgba(26,122,94,.07);border:1px solid rgba(26,122,94,.2);border-radius:6px;font-size:11px;color:#6a6a60;line-height:1.7">&#128274; <strong style="color:#2a2825">Beveiliging & privacy</strong><br>Uw verbinding is versleuteld (HTTPS). Gegevens opgeslagen in Cloudflare EU-datacenters (Frankfurt, Duitsland). Toegang alleen met uw persoonlijke code. Geen gegevensverkoop aan derden. <a href="privacy.html" style="color:#1a7a5e">Privacyverklaring</a> &middot; <a href="voorwaarden.html" style="color:#1a7a5e">Voorwaarden</a></div>'
    ...
    +'<div style="pointer-events:auto;text-align:right"><a href="privacy.html" style="font-size:11px;color:var(--muted);text-decoration:none">Privacyverklaring</a> &middot; <a href="voorwaarden.html" style="font-size:11px;color:var(--muted);text-decoration:none">Voorwaarden</a></div>'
    +'</div>'
    +'</div>';
}
