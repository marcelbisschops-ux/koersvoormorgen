    ...
    document.getElementById('dv-ok').onclick=async function(){
      ...
      try{
        ...
        var koppen='## Managementsamenvatting\n(3-5 bullets over de kern van het voorstel, dan één alinea "In één zin")\n\n'
          ...
          +'## Onderhandelruimte: verdeling van de opbrengst naar zekerheid\n(interpreteer de verdeling hieronder in 3-4 zinnen vanuit het perspectief van de verkoper: welk deel is zeker bij closing (contante cash), welk deel is uitgesteld maar doorgaans zeker (escrow), welk deel is écht voorwaardelijk (earn-out, de earn-up, eventuele verkoperslening) en welk deel is behouden belang — dat laatste is geen betaling van de koper maar de waarde van het niet-verkochte deel, met een waarde die pas bij een tweede exit vaststaat. Als er een earn-up in de voorwaardelijke laag zit: benoem dat die afhankelijk is van het realiseren van de prognose. Benoem concreet waar de verkoper in de onderhandeling aan kan draaien — bijv. een groter deel cash bij closing tegen een lagere prijs, een kortere escrow, een kleinere earn-out-tranche, of meer/minder behouden belang. BELANGRIJK: "zeker" betekent contant op de closingdatum, niet gegarandeerd. Gebruik uitsluitend de tabel, verzin geen bedragen of percentages)\n[TABEL:ZOPA]\n\n'
          +(batna?'## BATNA & walk-away: onderhandelpositie van de verkoper\n(interpreteer de tabel hieronder in 3-4 zinnen: leg uit wat de walk-awayprijs is (de ondergrens waaronder het alternatief zonder deze deal aantrekkelijker is), hoe de zekere cash bij closing en de totale tegenprestatie zich daartoe verhouden, en wat het oordeel — BOVEN / KRAP / ONDER de walk-away — betekent voor de onderhandelingsstrategie. Betrek de tijdsdruk van de verkoper: bij hoge tijdsdruk weegt zekere cash zwaarder, bij lage tijdsdruk is er ruimte om te wachten of een andere partij te benaderen. BELANGRIJK: de walk-awayprijs en de geschatte BATNA-waarde zijn door de begeleider ingevoerde aannames, geen platformberekening — schrijf dat ook zo. Is de walk-awayprijs niet ingevuld, adviseer dan die eerst te bepalen. Gebruik uitsluitend de tabel, verzin geen bedragen. Dit deel is uitsluitend voor de verkoper en de begeleider, niet voor de koper)\n[TABEL:BATNA]\n\n':'')
          +(isSellDv?'## LoI-checklist: leg de kern-economics vroeg vast\n(loop de checklist langs en benoem de 3-5 belangrijkste punten die NOG NIET vastliggen ("leg vast in LoI") als concrete onderhandelprioriteit voor de LoI — leg per punt in één zin uit waarom laat vastleggen leverage kost. Behandel dit als: de LoI onderhandelen alsof het de SPA is. BELANGRIJK: dit is een aandachtspuntenlijst, GEEN juridisch advies — reps & warranties, MAC en opschortende voorwaarden horen met een jurist te worden uitgewerkt; schrijf dat ook zo. Gebruik uitsluitend de tabel. Dit deel is voor de verkoper en de begeleider, niet voor de koper)\n[TABEL:LOICHECKLIST]\n\n':'')
