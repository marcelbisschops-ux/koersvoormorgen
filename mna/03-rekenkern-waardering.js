  ...
  if(isBegOrAdmin){
    ...
    if(meetBtn)meetBtn.addEventListener('click',async function(){
      ...
      try{
        ...
        var resp=await fetchMetTimeout(WORKER+'/ai',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({messages:[{role:'user',content:prompt}],max_tokens:1500})},60000);
