...
6. **Homepage — visuele/positionerings-upgrade** (26 augustus 2026, Marcel deelde een externe (AI-gegenereerde) review van koersvoormorgen.nl). Kernoordeel gedeeld: structuur/tekst/duidelijkheid zijn al sterk, maar de site oogt nu meer als "nette SaaS-tool" dan als premium M&A-platform, vooral omdat er nergens een echt productbeeld staat — alleen tekst. **Nog niet gebouwd, eerst vastgelegd.** Vier deelpunten, oplopend in omvang/risico:
   1. **Hero-visual boven de vouw** (grootste impact): een hoogwaardige mock-up/schermafbeelding van een overnametraject-dashboard, met de dealfases (Voorbereiding → Teaser → Interesse → DD → Onderhandeling → Closing) zichtbaar. Nu is de eerste indruk volledig tekstueel.
   2. **Premiumere visuele stijl**: sterkere typografische hiërarchie, grotere headlines, meer contrast — huidige serif/sans-combinatie en witruimte zijn een goede basis, dit is aanscherpen, geen herontwerp.
   3. **Featurekaarten met echte productscreenshots** i.p.v. de huidige 5 tekstblokken ("Alles per fase en per rol", "Eén centrale dataroom", enz.). **Let op, vereist zorgvuldigheid:** een screenshot van het platform mag nooit échte klant-/trajectdata tonen (GOUDEN STANDAARD, CLAUDE.md) — dit vereist eerst een schoon fictief demo-traject specifiek voor marketingbeelden, vóór er iets vastgelegd/ontworpen wordt. Dit maakt dit deelpunt een eigen klein project, geen directe stijlwijziging.
   4. **Scherpere propositie op de homepage**: de homepage combineert nu drie proposities (platform/kantoorscan/matching) die om aandacht concurreren. Dit is geen nieuwe observatie — sluit aan bij de bevinding van 23 augustus 2026 (zie werkregel 18 in CLAUDE.md) dat teaser/verkoopmemorandum/matching destijds al geen kloppend geheel vormden en index.html niet was bijgewerkt. Voorstel uit de review: kantoorscan als duidelijke secondary CTA, matching-platform als aparte propositie behandelen — vereist een keuze van Marcel over de gewenste homepage-indeling vóór bouwen.
