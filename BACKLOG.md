...
8. **Openstaande punten uit de matching-platform/facturatie-bouwronde (24 augustus 2026):**
   ...
   - **Privacyverklaring (`privacy.html`) mist een rij voor de matching-interesseregistratie** — het nieuwe interesseformulier op het matching-platform verzamelt voor het eerst persoonsgegevens (naam/e-mail/IP) van een anonieme bezoeker die zich als koper aanmeldt, buiten een bestaand traject/adviseur om — dat past nog niet onder een bestaande rij in sectie 2 ("Welke gegevens verzamelen wij?") of de bijbehorende bullet in sectie 3. Concept-tekst is als voorstel aan Marcel gegeven in de chat van 24 augustus (niet zelf in het bestand gezet, werkregel 11d: juridische tekst wijzigt nooit automatisch) — nog door Marcel te beoordelen/laten checken en zelf te verwerken.
