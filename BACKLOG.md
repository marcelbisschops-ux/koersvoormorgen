...
| 7 | Branding neutraliseren (white-label basis) — ✅ ALLE PORTALS AF | Sonnet | 6–10 u | €600–1.000 | Centrale `BRAND`-config in **alle vijf portals** (mna, adv, marilyn, index, + VerhuisScan: hugo & verhuis); alle UI-chrome (headers/wordmarks/titels/footers) eraan gekoppeld — één wijziging = overal. Elk live bewezen (→ "DealScope"/"MoveScan"/"ScanPro"). **Rest = alleen nog dieper: legal-templates, AI-prompts & juridische copyright die "Bisschops Financing"/"accountancy" hardgecodeerd noemen** |
